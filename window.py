...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QSize(495, 195))
        MainWindow.setMaximumSize(QSize(495, 195))
        ...
        self.pushButton_run.setGeometry(QRect(10, 140, 281, 45))
        self.top_image = QLabel(self.centralwidget)
        self.top_image.setObjectName(u"top_image")
        self.top_image.setGeometry(QRect(-10, 0, 301, 91))
        ...
        self.pushButton_folder.setGeometry(QRect(130, 100, 40, 40))
        icon1 = QIcon()
        ...
        self.pushButton_config.setGeometry(QRect(90, 100, 40, 40))
        icon2 = QIcon()
        ...
        self.pushButton_reload.setGeometry(QRect(170, 100, 40, 40))
        icon3 = QIcon()
        ...
        self.pushButton_download.setGeometry(QRect(50, 100, 40, 40))
        icon4 = QIcon()
        ...
        self.pushButton_create.setGeometry(QRect(10, 100, 40, 40))
        icon5 = QIcon()
        ...
        self.pushButton_exit.setGeometry(QRect(250, 100, 40, 40))
        icon7 = QIcon()
