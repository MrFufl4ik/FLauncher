...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(300, 245)
        Form.setMinimumSize(QSize(300, 245))
        Form.setMaximumSize(QSize(300, 245))
        icon = QIcon()
        icon.addFile(u"assets/frog_launcher_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        Form.setWindowIcon(icon)
        self.top_image = QLabel(Form)
        self.top_image.setObjectName(u"top_image")
        self.top_image.setGeometry(QRect(0, 0, 301, 91))
        ...
        self.comboBoxLoader.setGeometry(QRect(60, 130, 231, 22))
        self.comboBoxVersion = QComboBox(Form)
        self.comboBoxVersion.setObjectName(u"comboBoxVersion")
        self.comboBoxVersion.setGeometry(QRect(60, 150, 231, 22))
        ...
        self.lineEditPlayerName.setGeometry(QRect(10, 181, 161, 21))
        self.pushButtonDone = QPushButton(Form)
        self.pushButtonDone.setObjectName(u"pushButtonDone")
        self.pushButtonDone.setGeometry(QRect(175, 180, 120, 50))
        self.label = QLabel(Form)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(10, 130, 61, 20))
        self.label_2 = QLabel(Form)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 150, 61, 20))
        self.lineEditVisualName = QLineEdit(Form)
        self.lineEditVisualName.setObjectName(u"lineEditVisualName")
        self.lineEditVisualName.setGeometry(QRect(10, 100, 281, 21))
        self.lineEditJavaArgs = QLineEdit(Form)
        self.lineEditJavaArgs.setObjectName(u"lineEditJavaArgs")
        self.lineEditJavaArgs.setGeometry(QRect(10, 210, 161, 21))
