...
def get_current_index_lw(lw: QListWidget) -> int | None:
    if lw.currentItem():
...
def none_string(s: str) -> str | None:
...
class FLauncherWindow(QMainWindow):
    def __init__(self):
        ...
        self.download_ui_window = None
        self.download_window = None
        self.settings_ui_window = None
        self.settings_window = None
        self.create_ui_window = None
        self.create_window = None
        self.log_window = None
        self.log_ui_window = None
        self.modpacks = None
        self.ftp = None
    ...
    def update_or_install_modpack(self):
        ...
        if config is not None:
            ...
            if update_ip is not None and update_port is not None and update_user is not None and update_pass is not None:
                ftp = update_manager.create_ftp(str(update_ip), int(str(update_port)), str(update_user), str(update_pass))
                if ftp is not None:
